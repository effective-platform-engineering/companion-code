...
const (
	LoginClientId = "{{ op://my-vault/svc-auth0/epectl-cli-client-id }}"
	LoginScope    = "openid offline_access profile email"
	LoginAudience = "https://epectl.us.auth0.com/api/v2/"
	IdpIssuerUrl  = "https://epectl.us.auth0.com/"

	DefaultShowHidden = false
	DefaultCluster    = "prod-i01-aws-us-east-2"

	ConfigEnvDefault             = "epectl"
	ConfigFileDefaultName        = "config"
	ConfigFileDefaultType        = "yaml"
	ConfigFileDefaultLocation    = "/.epectl" // path will begin with $HOME dir
	ConfigFileDefaultLocationMsg = "config file (default is $HOME/.epectl/config.yaml)"
)

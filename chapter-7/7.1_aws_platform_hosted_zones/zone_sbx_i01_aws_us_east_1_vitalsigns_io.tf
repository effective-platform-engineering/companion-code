...
provider "aws" {
  alias  = "subdomain_sbx_i01_aws_us_east_1_vitalsigns_io"
  region = "us-east-1"
  assume_role {
...
module "subdomain_sbx_i01_aws_us_east_1_vitalsigns_io" {
  source  = "terraform-aws-modules/route53/aws//modules/zones"
  version = "3.1.0"
  create  = true

  providers = {
    aws = aws.subdomain_sbx_i01_aws_us_east_1_vitalsigns_io
  }

  zones = {
    "sbx-i01-aws-us-east-1.${local.domain_vitalsigns_io}" = {
      tags = {
...
module "subdomain_zone_delegation_sbx_i01_aws_us_east_1_vitalsigns_io" {
  ...
  records = [
    {
      ...
      records         = module.subdomain_sbx_i01_aws_us_east_1_vitalsigns_io.route53_zone_name_servers["sbx-i01-aws-us-east-1.${local.domain_vitalsigns_io}"]
    }
  ]

  depends_on = [module.subdomain_sbx_i01_aws_us_east_1_vitalsigns_io]
}
